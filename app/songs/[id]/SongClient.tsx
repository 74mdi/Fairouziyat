...
interface SongDetail {
  id: number; title: string; album_id: number; album_name: string;
  lyricist: string | null; composer: string | null; maqam: string | null;
  lyrics: string | null; audio_local: string | null; audio_opus: string | null;
  audio_m4a: string | null; prev_id: number | null; next_id: number | null;
  cover_local: string | null;
}

export default function SongClient({ song }: { song: SongDetail }) {
